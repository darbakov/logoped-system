...
import { cn, calculateAge, CLIENT_STATUSES } from "@/lib/utils";
...
export default function SpeechCardsIndexPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Речевые карты</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Выберите ученика для просмотра или создания речевой карты
        </p>
      </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground/60 mt-1">
                  Речевых карт: {client._count.speechCards}
                </p>
              </div>
